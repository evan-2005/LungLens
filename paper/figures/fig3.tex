...
\node[frozen, proc, text width=13mm, minimum height=4.5mm, below=1mm of s3-loc] (s3-fb) {{\tiny Grad-CAM fallback\\(23/245 films)}};
...
\node[tag, above=1.8mm of s3-mask] (tagH) {H0--H5 enters here};
...
\node[tag, above=1.8mm of s3-rep, xshift=-5mm] (tagS) {S0--S4 enters here};
